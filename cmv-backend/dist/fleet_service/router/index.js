...
import { createCost, createVehicle, deleteCost, deleteVehicle, getCost, getVehicle, getVehicles, updateVehicle, } from '../service/index.js';
...
routes.get('/vehicle_cost/:id', [jwtErrorHandler, RBAC('read', 'vehicle-detail')], getCost);
